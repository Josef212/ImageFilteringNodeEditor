...
def load_plain_texture(width, height, r, g, b, a, buffer):
    buffer.clear()
...
texture_data = []
load_plain_texture(100, 100, 255 / 255, 0, 255 / 255, 255 / 255, texture_data)
...
def _update_dynamic_textures(sender, app_data, user_data):
    ...
    new_texture_data = []
    load_plain_texture(100, 100, new_color[0], new_color[1], new_color[2], new_color[3], new_texture_data)
